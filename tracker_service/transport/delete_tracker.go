...
func (t transport) DeleteTracker(ctx context.Context, request *contract.IDTrackerReq) (response *contract.DefaultResponse, err error) {
	// * Bridging to usecase related method
	return t.UseCase.DeleteTracker(ctx, request)
}
