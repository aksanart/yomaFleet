...
type TrackerServiceClient interface {
	...
	CreateTracker(ctx context.Context, in *CreateTrackerReq, opts ...grpc.CallOption) (*DefaultResponse, error)
...
func (c *trackerServiceClient) CreateTracker(ctx context.Context, in *CreateTrackerReq, opts ...grpc.CallOption) (*DefaultResponse, error) {
	out := new(DefaultResponse)
...
func (UnimplementedTrackerServiceServer) CreateTracker(context.Context, *CreateTrackerReq) (*DefaultResponse, error) {
