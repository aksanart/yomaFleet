...
// ExpireStream mocks base method.
func (m *MockRedisInterface) ExpireStream(ctx context.Context, key string, ttl time.Duration) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ExpireStream", ctx, key, ttl)
	ret0, _ := ret[0].(error)
	return ret0
}

// ExpireStream indicates an expected call of ExpireStream.
func (mr *MockRedisInterfaceMockRecorder) ExpireStream(ctx, key, ttl any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ExpireStream", reflect.TypeOf((*MockRedisInterface)(nil).ExpireStream), ctx, key, ttl)
}

// GetData mocks base method.
func (m *MockRedisInterface) GetData(ctx context.Context, key string, pointerData any) (any, error) {
	m.ctrl.T.Helper()
...
func (m *MockRedisInterface) GetStreamClient(ctx context.Context, streamName string) ([]v8.XStream, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetStreamClient", ctx, streamName)
	ret0, _ := ret[0].([]v8.XStream)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockRedisInterface) RangeData(ctx context.Context, streamName string) ([]v8.XMessage, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "RangeData", ctx, streamName)
	ret0, _ := ret[0].([]v8.XMessage)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
