...
import (
	...
	repointerface "github.com/aksan/weplus/apigw/repository/repo_interface"
)
...
type Repository struct {
	...
	VehicleService repointerface.VehicleServiceIface
	TrackerService repointerface.TrackerServiceIface
}

type MongoCollections struct {
	User repointerface.MongoInterface
}
